...
public class MoneyTransfer {
	...
	public String getReferenceNumberSize() {
		return referenceNumberSize;
	}

	public void setReferenceNumberSize(String referenceNumberSize) {
		this.referenceNumberSize = referenceNumberSize;
	}
